...
export default function kpiComponent() {
    ...
    function updateDimns(nrOfNumberValues, handlesAreAbove, handlesAreBelow, nrTooltipRows){
        ...
        //NOTE - CALL THIS PROGRESSBAR NOW, AND THE BAR IS PART OF THAT, BUT SO ARE TOOLTIPS AND HANDLES
    ...
    function kpi(selection, options={}) {
        ...
        selection
            ...
            //.call(container().parent("g.kpi-contents").className("progress-bar-contents").margin(progressBarMargin))
