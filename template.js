export default () => {
  return `<!doctype html>
    <html lang="en">
      <head>
        <meta http-equiv="Content-Security-Policy" content="font-src 'self' 'unsafe-inline' https://fonts.gstatic.com data:; img-src 'self' data:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com data:; script-src 'unsafe-eval' 'unsafe-inline' http://localhost:3000/dist/bundle.js https://switchplay-app.herokuapp.com/dist/bundle.js http://www.switchplay.co.uk/dist/bundle.js https://www.switchplay.co.uk/dist/bundle.js data:; default-src 'self' localhost:* https://www.youtube.com/ https://www.youtube-nocookie.com/">
        <meta name="viewport" content="minimum-scale=1, initial-scale=1, maximum-scale=1.0, width=device-width, shrink-to-fit=no" charset="utf-8">
